...
metadata {
    definition(name: "Tasmota Garage Door", namespace: "hongtat", author: "HongTat Tan", ocfDeviceType: "oic.d.switch") {
        capability "Actuator"
    ...
    tiles(scale: 2) {
        multiAttributeTile(name: "switch", type: "lighting", width: 6, height: 4, canChangeIcon: true) {
            tileAttribute("device.switch", key: "PRIMARY_CONTROL") {
                attributeState "on", label: '${name}', action: "switch.off", icon: "st.contact.contact.open", backgroundColor: "#00A0DC"
